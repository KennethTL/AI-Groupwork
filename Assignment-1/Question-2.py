...
def getPriorityQueue(listNode):
	q = Q.PriorityQueue()
	for node in listNode:
		q.put(Ordered_Node(heuristics[node],node))
	return q,len(listNode)
...
# def getHeuristics(G):
# 	heuristics = {'SportsComplex':730,'Siwaka':405,'Phase1A':380,'Phase1B':280,'STC':213,'Phase2':210,'J1':500,'Phase3':160,'Madaraka':630,'ParkingLot':0}
